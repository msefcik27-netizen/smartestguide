...
# Shoda se ŽENSKÝM PODMĚTEM (nález Martina 25. 9. 2026): „…s recepcí, která vám rád
# poskytne…" — recepce je rodu ženského, má být „ráda". Tohle NENÍ první osoba, takže
# to pravidla výše nechytnou. Jedinou bezpečnou kotvou je vztažné zájmeno „která":
...
def _alex_feminine_fix(text: str) -> str:
    ...
    a srovná shodu po vztažném „která". Cizí jazyky nezasáhne — vzory jsou
    ryze české/slovenské."""
    if not text:
        return text
    def _past(m):
        w = m.group(1)
...
CLOSING A REPLY: When you end a reply by offering more help, offer YOUR help — do not ask what the guest wants. Czech: "Mohu vám ještě s něčím pomoci?" or "Ráda vám poradím i s čímkoli dalším." NOT "Chcete ještě něco?" / "Máte ještě nějaké přání?". Same in every language: offer assistance, don't interrogate. Keep it to one short sentence, and skip it entirely when it would sound repetitive.
